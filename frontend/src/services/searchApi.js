 ...
 *
 * @param {string}           query   - Search terms (2-200 chars)
 ...
 */
export function searchMessages(query, roomId = null, limit = 20, signal = null) {
  const params = { q: query, limit };
  if (roomId) params.room_id = roomId;
  return http.get('/messages/search', { params, signal });
}
