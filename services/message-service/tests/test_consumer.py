# tests/test_consumer.py — Tests for the persistence consumer lifecycle
#
# Covers:
...
#   - _persist_private_message with missing user id in auth response
import asyncio
...
# ══════════════════════════════════════════════════════════════════════
# Private message edge cases
# ══════════════════════════════════════════════════════════════════════


class TestPrivateMessageEdgeCases:
    """Tests for edge cases in private message persistence."""
